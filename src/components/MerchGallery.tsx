      ...
      {merchList.map((merchDetails, index) => (
        <Link to="product" state={{ itemId: merchDetails.id }}>
          <li
            key={index}
            className={
              (index != merchList.length - 1 ? "mb-5 " : "") +
              "w-[90vw] flex items-center md:flex-col md:w-[200px] md:h-[420px] md:bg-transparent md:mb-0 bg-gray-200 p-3 rounded-md hover:brightness-75 hover:bg-gray-100 cursor-pointer"
            }
          >
